#
#  Be sure to run `pod spec lint HJ_UIKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "You Jie" => "282295491@qq.com" }
  # Or just: s.author    = "You Jie"
  # s.authors            = { "You Jie" => "282295491@qq.com" }
  # s.social_media_url   = "http://twitter.com/You Jie"
  ...
  s.source       = { :git => "https://github.com/Jacue/HJ_UIKit.git", :tag => s.version.to_s }
  ...
  # s.source_files  = "HJ_UIKit/Classes/**/*"
