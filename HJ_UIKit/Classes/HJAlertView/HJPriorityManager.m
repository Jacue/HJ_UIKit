...
@implementation HJPriorityManager

+ (instancetype)sharedManager {
    static HJPriorityManager *instance = nil;
...
- (NSInteger)indexOfHightestPriorityAlertView {
    NSInteger index = 0;
    NSInteger level = 0;
    for (UIView<HJPriorityProtocol> *alertView in self.lowPriorityAlertViewArray) {
